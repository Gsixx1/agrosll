...
<body>
  ...
  <div class="contact-banner">
    <p><h3>CONTACT US ABOUT ALL AGRICULTURE PRODUCTS</h3></p>
    <p><h5>Anim aute ex aute irure sit labore adipisicing duis ullamco est. 
      Minim incididunt laborum nisi do et aute. Quis ad esse laboris ullamco 
      dolor quis quis eu do elit elit. Ea sunt ea in reprehenderit pariatur 
      quis id ut proident aliquip ut..</h5></p>
  </div>
  <section id="main-contact-field">
    <div class="inner-card">
      <div class="contact-col1">
        <div class="tel-card">
          <div class="tel-icon"><img src="/resources/pngss/icons8-ringer-volume-50.png" alt=""></div>
          <div class="tel-number"><h4>+232-76-458-340</h4></div>
        </div>
        <div class="address-card">
          <div class="cont-home-icon"><img src="/resources/pngss/icons8-address-50.png" alt=""></div>
          <div class="cont-address"><h5>#68 Wilkingson Road, <br> Freetown, <br> Sierra Leone.</h5></div>
        </div>        
      </div>
        ...
        <div class="contact-form">
          ...
          <div class="form">
            <form action="">
              <fieldset>
                <div class="topnames">
                <input type="text" id="frm-fname" name="frm-fname" placeholder="First Name" required>
                <input type="text" id="frm-lname" name="frm-lname" placeholder="Last Name" required>
              </div>
              <div class="cont-email">
                <input type="text" id="cont-email-input" placeholder="Email" required>
              </div>
              <div class="cont-textarea">
                <textarea name="" style="resize:none;" class="" id="text-area-cont" cols="30" rows="10" placeholder="Input your text" required></textarea>
              </div>              
              </fieldset>
            </form>
            <div class="cont-frm-bottom">
              <input type="button" value="Send" id="cont-frm-btn">
            </div>
          </div>      
    ...
    <div class="map">
      <div class="mapouter">
        <div class="gmap_canvas"><iframe width="1000" height="500" id="gmap_canvas"
            src="https://maps.google.com/maps?q=freetown&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no"
            marginheight="0" marginwidth="0"></iframe><a href="https://123movies-to.org"></a><br>
          <style>
            .mapouter {
              position: relative;
              text-align: right;

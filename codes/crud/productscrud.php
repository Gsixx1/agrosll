...
<nav class="nav">
    ...
    <div class="container mb-5 " style="overflow:none">
        <div class="row overflowAuto " style="overflow:hidden !important" >
            <!-- PHP CODE -->
            <?php 
            ...
            <!-- <div class="col-md-4 col-sm-6 col-xs-12 mb-5">
                <div class="card" style="width: 18rem;">
                    <img src="/codes/crud/pics/green-leaves-1410259.jpg" class="card-img-top" alt="card image" style="object-fit:contain; height:197px">
                    <div class="card-body">
            ...
            <!-- <div class="col-md-4 col-sm-6 col-xs-12 mb-5">
                <div class="card" style="width: 18rem;">
                    <img src="/codes/crud/pics/istockphoto-1318850180-170667a.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary">Go somewhere</a>
